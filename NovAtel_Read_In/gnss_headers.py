class GNSS_Headers():
    ...
    def __init__(self,  header = ["Log_name", "Port", "Sequence#", "% Idle Time", "Time_Status", "Week", "Seconds", "Receiver_Status", "Null", "Receiver_S/W_Version"],
                        rtk_cols = ["sol_status", "pos_type", "lat", "lon", "hgt", "undulation", 
                        ...
                        ppp_cols = ["sol_status", "pos_type", "lat", "lon", "hgt", "undulation", "datum_id#", 
                        ...
                        psr_cols = ["sol_status", "pos_type", "lat", "lon", "hgt", "undulation", "datum id#", "lat_sigma", 
